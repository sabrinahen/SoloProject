            ...
            <div className="nav-bottom">
                <div className="nav-bottom-left">
                    <div className="nav-logo">
                        <img src="https://www.freeiconspng.com/thumbs/sun-icon/sun-icon-31.png" alt="sun" width="30" height="30"/>
                        <h5 style={{paddingRight: "20px", paddingLeft:"20px"}}>FitGirl Summer</h5>
                        <img src="https://www.freeiconspng.com/thumbs/sun-icon/sun-icon-31.png" alt="sun" width="30" height="30"/>
                </div>
